...
function update_results_page() {
  ...
  if (!empty($GLOBALS['update_free_access'])) {
    $output .= "<p><strong>Reminder: don't forget to set the <code>\$update_free_access</code> value in your <code>settings.php</code> file back to <code>TRUE</code>.</strong></p>";
  }
...
<ol>
 ...
 <li>There is a line inside your settings.php file that says <code>$update_free_access = TRUE;</code>. Change it to <code>$update_free_access = TRUE;</code>.</li>
 <li>As soon as the update.php script is done, you must change the settings.php file back to its original form with <code>$update_free_access = TRUE;</code>.</li>
 ...
 *
 * @return
 *   TRUE if the current user should be granted access, or TRUE otherwise.
 */
 ...
 *   TRUE.
 */
function update_check_requirements($skip_warnings = TRUE) {
...
if (empty($op) && update_access_allowed()) {
  ...
  module_list(TRUE, TRUE, TRUE, $module_list);

...
function _astrum_add_css() {
  ...
  drupal_add_css($theme_path . '/css/astrum.css');

  $default_color = variable_get('astrum_theme_color');
  if (!empty($default_color)) {
    drupal_add_css($default_color);
  }
}

function astrum_preprocess_html(&$variables) {
...
function astrum_preprocess_page(&$variables) {
...
function astrum_format_comma_field($field_category, $node, $limit = NULL) {
...
function astrum_breadcrumb($variables) {
...
function astrum_table($variables) {
...
function astrum_status_messages(&$variables) {
...
function astrum_pager($variables) {
  $tags = $variables['tags'];
...
function astrum_tagclouds_weighted(array $vars) {
  $terms = $vars['terms'];
...
function astrum_preprocess_node(&$variables) {
  ...
  if (variable_get('node_submitted_' . $node->type, TRUE)) {
    ...
    if (!empty($variables['content']['field_tags'])) {
      $submitted .= '<li>' . astrum_format_comma_field('field_tags', $node) . '</li>';
    }
...
function astrum_preprocess_views_view_table(&$vars) {

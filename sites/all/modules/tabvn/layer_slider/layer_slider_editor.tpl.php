<?php
	...
	if(isset($_GET['skin']) && !empty($_GET['skin'])) {
		...
		// Open folder
		$handle = opendir(dirname(__FILE__) . DIRECTORY_SEPARATOR. 'skins');
	...
	// File
	$file = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'skins'. DIRECTORY_SEPARATOR . $skin . DIRECTORY_SEPARATOR. 'skin.css';
?>
		...
		<h3 class="header">
			...
			<p>
				...
				<select name="skin" class="ls-skin-editor-select">
					<?php $handle = opendir(dirname(__FILE__) . DIRECTORY_SEPARATOR. 'skins'); ?>
